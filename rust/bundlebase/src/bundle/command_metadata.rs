...
pub fn command_metadata() -> Vec<(&'static str, &'static str, &'static str)> {
    let mut entries = vec![
        ...
        (
            "ATTACH",
            "ATTACH '<path>' [TO <pack>] [WITH (<options>)]",
            "read-write",
        ),
        ...
        (
            "JOIN",
            "[LEFT|RIGHT|FULL|INNER] JOIN '<path>' AS <name> ON <expression>",
            "read-write",
        ),
        (
            "REPLACE",
        ...
        (
            "IMPORT CONNECTOR",
            "IMPORT CONNECTOR <name> FROM '<runtime::entrypoint>' [WITH (<args>)]",
            "read-write",
        ),
        (
            "IMPORT FUNCTION",
            "IMPORT FUNCTION <name> FROM '<runtime::entrypoint>' [WITH (<args>)]",
            "read-write",
        ),
        (
            "RENAME CONNECTOR",
            "RENAME CONNECTOR <old> TO <new>",
            "read-write",
        ),
        (
            "RENAME FUNCTION",
        ...
        (
            "CREATE SOURCE",
            "CREATE SOURCE [FOR <pack>] USING <connector> [WITH (<args>)]",
            "read-write",
        ),
        ...
        (
            ...
            "IMPORT TEMP CONNECTOR <name> FROM '<runtime::entrypoint>' [WITH (<args>)]",
            "read-only",
        ),
        (
            "IMPORT TEMP FUNCTION",
            "IMPORT TEMP FUNCTION <name> FROM '<runtime::entrypoint>' [WITH (<args>)]",
            "read-only",
        ),
        (
            "DROP TEMP CONNECTOR",
        ...
        (
            "DROP TEMP FUNCTION",
            "DROP TEMP FUNCTION <name>",
            "read-only",
        ),
        (
            "RENAME TEMP CONNECTOR",
            "RENAME TEMP CONNECTOR <old> TO <new>",
            "read-only",
        ),
        (
            "RENAME TEMP FUNCTION",
            "RENAME TEMP FUNCTION <old> TO <new>",
            "read-only",
        ),
        (
            "EXPLAIN",
