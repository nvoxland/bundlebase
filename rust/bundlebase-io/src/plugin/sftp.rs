...
config_scopes!(sftp_scopes, {
    pub const SFTP_SCOPE: ConfigScope = ConfigScope::new("sftp");
});
...
mod tests {
    ...
    fn test_sftp_file_from_url() {
        ...
        let sftp_file = SftpFile::from_url(&url, crate::test_utils::test_config()).unwrap();
    ...
    fn test_sftp_dir_from_url() {
        ...
        let sftp_dir = SftpDir::from_url(&url, crate::test_utils::test_config()).unwrap();
