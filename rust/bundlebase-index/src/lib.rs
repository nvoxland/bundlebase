...
pub use text_column_index::{
    build_unified_index, search_in_unified, search_unified, search_unified_cached,
    unified_index_cached, TextIndex, TextIndexBuilder, UnifiedIndex, UnifiedSearchHit,
};
